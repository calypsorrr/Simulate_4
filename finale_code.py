...
with open('logs/youtube_insert_id.json', 'w', encoding='utf8') as f:
...
with open('logs/facebook_insert_id.json', 'w', encoding='utf8') as f:
    json.dump(data, f, ensure_ascii=False)
...
def read_notion_Youtube_id(databaseId_youtube, headers_post):
    ...
    with open('logs/youtube.json', 'w', encoding='utf8') as f:
        json.dump(data, f, ensure_ascii=False)
